...
void _subscriptionSerialize(
  ...
  writer.writeBool(offsets[1], object.isVip);
...
extension SubscriptionQueryFilter
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition> isVipEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isVip',
...
extension SubscriptionQuerySortBy
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByIsVip() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isVip', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByIsVipDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isVip', Sort.desc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByProductId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'productId', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByProductIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionQuerySortThenBy
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByIsVip() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isVip', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByIsVipDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isVip', Sort.desc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByProductId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'productId', Sort.asc);
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByProductIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'productId', Sort.desc);
    });
  }
...
extension SubscriptionQueryWhereDistinct
  ...
  QueryBuilder<Subscription, Subscription, QDistinct> distinctByIsVip() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isVip');
    });
  }

  QueryBuilder<Subscription, Subscription, QDistinct> distinctByProductId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionQueryProperty
  ...
  QueryBuilder<Subscription, bool, QQueryOperations> isVipProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isVip');
    });
  }

  QueryBuilder<Subscription, String, QQueryOperations> productIdProperty() {
    return QueryBuilder.apply(this, (query) {
